...
# needs to exist for color themer to work
array set ::pd_colors {
    gop_box 		         "#AB6526"
...
proc find_default_font {} {
    set testfonts { "DejaVu Sans Mono" "Bitstream Vera Sans Mono" \
                    "Menlo" "Monaco" "Inconsolata" "Courier 10 Pitch" \ 
...
proc pdtk_pd_startup {major minor bugfix test
    ...
    load_startup_plugins ;# we can load the radiance theme here
    ::pdwindow::set_colors ;# use plugin settings for the console
    open_filestoopen
    set ::done_init 1
}
...
proc load_startup_plugins {} {
    ...
    load_plugin_script [file join $::sys_guidir themes-plugin.tcl]
